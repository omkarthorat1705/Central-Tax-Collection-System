...
export default function CreateCitizenPage() {
  ...
  return (
    <AdminLayout sidebar={<AdminSidebar />} pageTitle="Citizen Registration">
      <div className="citizen-page">
        <div className="citizen-header">
          <div className="citizen-title">Citizen Registration</div>
            ...
            <div className="step-footer">
              ...
              {activeStep !== 5 ? (
                ...
                <Button
                  ...
                  disabled={saving}
                >
                  {saving ? "Creating Citizen..." : "Create Citizen"}
                </Button>
              )}
            </div>
          </div>
